 ...
 sm:bg-white  border-b-1 border-gray-800/70 border-opacity-40
 transition-all duration-200 font-montserrat
 h-20 /* initial size (changes if scrolled down) */
"
     :class="{ 'h-20 lg:bg-gray-800 lg:bg-opacity-40  md:bg-gray-800 md:bg-opacity-40 ': !
         scrolledFromTop, 'h-16 lg:bg-white': scrolledFromTop }">
         ...
         <div class="flex">
             ...
             <div class="py-1">
                 <p class="text-base leading-none font-bold "
                     :class="{ 'lg:text-gray-50 md:text-gray-50 sm:text-red-600': !
                         scrolledFromTop, 'text-red-600': scrolledFromTop }">
                     Rekrutmen</p>
                 <p class="text-lg font-bold "
                     :class="{ 'lg:text-gray-50 md:text-gray-50 sm:text-blue-800': !
                         scrolledFromTop, 'text-blue-800': scrolledFromTop }">
                     PT. GRAHA MUTU
                     PERSADA</p>
                 <hr class="border "
                     :class="{ 'lg:border-white md:border-white sm:border-blue-800': !
                         scrolledFromTop, 'border-blue-800': scrolledFromTop }">
