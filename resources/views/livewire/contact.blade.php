        ...
        <section class="">
            <div class="flex justify-center">
                <div class="text-center">
                    <h2 class="mb-12 text-3xl font-semibold">Hubungi Kami</h2>
                </div>
            </div>
                    ...
                    <form>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            ...
                            <label
                                ...
                                for="exampleInput90">Nama Lengkap
                            </label>
                        </div>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            <input type="email"
                            ...
                            <label
                                class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                                for="exampleInput91">Alamat E-mail
                            </label>
                        </div>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            <input type="email"
                            ...
                            <label
                                class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                                for="exampleInput91">Nomor Telepon / Whatsapp
                            </label>
                        </div>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            <textarea
                    ...
                    <div class="flex flex-wrap">
                            ...
                            <div class="flex items-start">
                                <div class="shrink-0">
                                    <div class="inline-block rounded-md bg-primary-100 p-4 text-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><style>svg{fill:#1831ba}</style><path d="M280 0C408.1 0 512 103.9 512 232c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-101.6-82.4-184-184-184c-13.3 0-24-10.7-24-24s10.7-24 24-24zm8 192a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm-32-72c0-13.3 10.7-24 24-24c75.1 0 136 60.9 136 136c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-48.6-39.4-88-88-88c-13.3 0-24-10.7-24-24zM117.5 1.4c19.4-5.3 39.7 4.6 47.4 23.2l40 96c6.8 16.3 2.1 35.2-11.6 46.3L144 207.3c33.3 70.4 90.3 127.4 160.7 160.7L345 318.7c11.2-13.7 30-18.4 46.3-11.6l96 40c18.6 7.7 28.5 28 23.2 47.4l-24 88C481.8 499.9 466 512 448 512C200.6 512 0 311.4 0 64C0 46 12.1 30.2 29.5 25.4l88-24z"/></svg>
                                    </div>
                                </div>
                                <div class="ml-6 grow">
                        ...
                        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                            <div class="flex items-start">
                                <div class="shrink-0">
                                    <div class="inline-block rounded-md bg-primary-100 p-4 text-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><style>svg{fill:#1831ba}</style><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
                                    </div>
                                </div>
                                <div class="ml-6 grow">
                                    <p class="mb-2 font-bold dark:text-white">
                                    ...
                                    <p class="text-neutral-500 dark:text-neutral-200">
                                        marketing@grahamutupersada.com
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                            <div class="align-start flex">
                                ...
                                <div class="ml-6 grow">
                                    <p class="mb-2 font-bold dark:text-white">Cabang Mojokerto</p>
                                    <p class="text-neutral-500 dark:text-neutral-200">
                                        Jl. Raya Pacing No.1, Mojokerep, Pacing, Kec. Bangsal, Kabupaten Mojokerto, Jawa Timur 61381
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                            <div class="align-start flex">
                                ...
                                <div class="ml-6 grow">
                                    <p class="mb-2 font-bold dark:text-white">Cabang Semarang</p>
                                    <p class="text-neutral-500 dark:text-neutral-200">
                                        Jl. Serasi Raya Pondok Babadan Baru No.D.16, Prampatan, Beji, Kec. Ungaran Tim., Kabupaten Semarang, Jawa Tengah 50519
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                            <div class="align-start flex">
                                ...
                                <div class="ml-6 grow">
                                    <p class="mb-2 font-bold dark:text-white">Cabang Depok</p>
                                    <p class="text-neutral-500 dark:text-neutral-200">
                                        Jl. Proklamasi No.14, Mekar Jaya, Kec. Sukmajaya, Kota Depok, Jawa Barat 16411
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                            <div class="align-start flex">
                                ...
                                <div class="ml-6 grow">
                                    <p class="mb-2 font-bold dark:text-white">Respresentative Office Kalimantan</p>
                                    <p class="text-neutral-500 dark:text-neutral-200">
