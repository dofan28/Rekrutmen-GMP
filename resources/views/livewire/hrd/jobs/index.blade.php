...
<div class="w-full">
    <div class="text-start">
        <h2 class="text-3xl font-bold tracking-wide text-gray-800">Mengelola Lowongan Kerja</h2>
    </div>
    @if (session()->has('success'))
    ...
    <div class="flex justify-between mt-4">
        <a wire:navigate href="/hrd/jobs/create"
            class="relative flex items-center w-56 bg-blue-800 cursor-pointer h-9 group hover:bg-blue-900 active:bg-blue-900">
            <span
                class="ml-8 font-semibold text-white transition-all duration-300 transform group-hover:translate-x-20">Publikasi
                Lowongan</span>
            <span
        ...
        @if ($hrd->hrddata->is_recruitment_staff)
            <a wire:navigate href="/hrd/jobs/publish-manage"
                class="relative flex items-center justify-start gap-2 p-2 pr-6 font-semibold duration-500 bg-blue-800 group hover:bg-blue-900 text-neutral-50">
                ...
                <span class="px-1 text-sm text-justify border-l-2">Mengelola Pengajuan <br> Publikasi Lowongan</span>
                <div
                    class="absolute z-10 inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-500 bg-blue-800 rounded shadow-sm opacity-0 group-hover:opacity-100 top-16 before:w-3 before:h-3 before:rotate-45 before:-top-1 before:left-20 before:bg-blue-600 before:absolute text-start">
