<div>
    <header>
        <nav class="w-full py-3">
            <ul class="flex items-center justify-between w-full text-gray-600">
                <li>
                    <h2 class="ml-4 text-2xl font-semibold lg:ml-10 xl:text-3xl">Informasi Lowongan</h2>
                </li>
                <li>
    ...
    <div class="pb-6">
        <div class="w-11/12 p-6 mx-auto text-gray-600 bg-white rounded-md shadow-md lg:mt-10 lg:w-3/4">
            <a wire:navigate href="/hrd/jobs/publish-manage" class="flex items-center mb-2 w-min">
                ...
                <p class="ml-2 font-medium">Kembali</p>
            </a>
            <div class="lg:flex">
                ...
                <div class="flex flex-col ">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-base text-gray-600">Email: {{ $job->jobcompany->email }}</p>
                        <p class="text-base text-gray-600">Telepon: {{ $job->jobcompany->phone }}</p>
                    </div>
