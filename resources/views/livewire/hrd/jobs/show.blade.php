<div>
    ...
    <div class="pb-6">
        <div class="w-11/12 p-6 mx-auto text-gray-600 bg-white rounded-md shadow-md lg:mt-10 lg:w-3/4">
            <a wire:navigate href="/hrd/jobs" class="flex items-center mb-2 w-min">
            ...
            <div class="flex flex-col ">
                ...
                <div class="mt-6">
                    <div class="flex items-baseline mt-6 mb-2">
                        ...
                        <p class="text-base text-neutral-600 dark:text-neutral-200">Penempatan : {{ $job->jobcompany->name }}</p>
                    </div>
                    <div class="flex items-center mb-2">
                        <i class="mr-3 fa-solid fa-user-graduate fa-lg"></i>
                        <p class="text-base text-neutral-600 dark:text-neutral-200">Pendidikan: {{ $job->jobeducation->name }}</p>
                    </div>
