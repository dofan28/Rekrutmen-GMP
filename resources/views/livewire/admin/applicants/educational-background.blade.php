<div>
    <header>
        <nav class="w-full pt-14 lg:py-3">
            <ul class="flex items-center justify-between w-full text-gray-600">
                <li>
                    <h2 class="ml-4 text-2xl font-semibold lg:ml-10 xl:text-3xl">Detail Riwayat Pendidikan</h2>
                </li>
    ...
    <div class="w-11/12 p-6 mx-auto mt-10 text-gray-600 bg-white rounded-md shadow-md lg:w-3/4">
        <a wire:navigate wire:navigate href="/admin/applicants" class="flex w-min items-center mb-4 hover:underline">
        ...
        @foreach ($educationalbackgrounds as $educationalbackground)
            ...
            <div class="mb-4">
                <label class="text-gray-600">Selesai Tanggal:</label>
