<div>
    <header>
        <nav class="w-full pt-14 lg:py-3">
            <ul class="flex items-center justify-between w-full text-gray-600">
                <li>
                    <h2 class="ml-4 text-2xl font-semibold lg:ml-10 xl:text-3xl">Detail Kontak</h2>
                </li>
    ...
    <div class="mt-10 w-11/12 lg:w-3/4 mx-auto bg-white p-6 rounded-md shadow-md text-gray-600">
        <a wire:navigate href="/admin/applicants" class="flex w-min items-center mb-4 hover:underline">
        ...
        <div class="mb-4">
            ...
            <p class="font-semibold">{{$applicantcontact->street}}, {{ $applicantcontact->subdistrict}}, {{$applicantcontact->city}}, {{$applicantcontact->province}}, {{$applicantcontact->postal_code}}</p>
        </div>
        <div class="mb-4">
            <label class="text-gray-600">Email:</label>
            <p class="font-semibold">{{$applicantcontact->email}}</p>
        </div>
        <div class="mb-4">
            <label class="text-gray-600">Nomor HP:</label>
            <p class="font-semibold">{{$applicantcontact->phone}}</p>
        </div>
        <div class="mb-4">
            <label class="text-gray-600">LinkedIn:</label>
            <p class="font-semibold">{{$applicantcontact->linkedin}}</p>
        </div>
        <div class="mb-4">
            <label class="text-gray-600">Facebook:</label>
            <p class="font-semibold">{{$applicantcontact->facebook}}</p>
        </div>
        <div class="mb-4">
            <label class="text-gray-600">Instagram:</label>
            <p class="font-semibold">{{$applicantcontact->instagram}}</p>
        </div>
    </div>
</div>
