<div>
    ...
    <div class="mx-4 lg:ml-8">
        ...
        @endif
        @if ($jobeducations->isEmpty())
            <div class="mt-24 text-gray-600">
                <h1 class="mb-2 text-2xl font-semibold text-center lg:text-3xl">Data pendidikan di tempat sampah tidak
                    tersedia.
                </h1>
            </div>
        @else
                ...
                <tbody class="">
                    @foreach ($jobeducations as $jobeducation)
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="px-4 py-3">
                                <a wire:navigate href="/admin/others/recyclebin/jobs/jobeducations/{{ $jobeducation->id }}/restore"
                                    class="px-2 py-1 text-white bg-blue-500 rounded hover:bg-blue-700">Pulihkan</a>
                                <form action="/admin/others/recyclebin/jobs/jobeducations/{{ $jobeducation->id }}/force"
                                    method="post"
