<div>
    <header>
        <nav class="w-full pt-14 lg:py-3">
            <ul class="flex items-center justify-between w-full text-gray-600">
                <li>
                    <h2 class="ml-4 text-2xl font-semibold lg:ml-10 xl:text-3xl">Detail Data Akun HRD</h2>
                </li>
                <li>
    ...
    <div class="mt-10 w-11/12 lg:w-3/4 mx-auto bg-white p-6 rounded-md shadow-md text-gray-600">
        <a wire:navigate href="/admin/hrds" class="flex w-min items-center mb-4 hover:underline">
        ...
        <div class="flex items-center justify-center mb-4">
            <img src="{{asset('storage/'. $hrd->photo)}}" alt="Foto" class="w-32 h-32 rounded-full object-cover">
        </div>
        <div class="mb-4">
