                    ...
                    <div class="mb-3">
                        @if (auth()->user()->educationalbackground->isEmpty())
                            ...
                            <p class="my-2 text-sm font-light text-gray-800 font-poppins ">Lengkapi data riwayat
                                pendidikan berikut. Untuk menjadi bahan pertimbangan dalam proses seleksi lamaran.</p>
                        @else
                    ...
                    @if (!auth()->user()->educationalbackground->isEmpty())
                        @foreach (auth()->user()->educationalbackground as $educationalbackground)
                            <div wire:key='{{ $educationalbackground->id }}' class="flex justify-between">
                                <div>
                                    <h4 class="pb-2 text-xl font-semibold text-gray-800">Pendidikan
                                ...
                                <div class="flex gap-1">
                                    <div>
                                        <a wire:navigate
                                            href="/applicant/profile/educationalbackgrounds/{{ $educationalbackground->id }}/edit"
