        ...
        <div
            ...
            <div class="py-4 md:pl-4">
                <div class="flex flex-col p-4 space-y-4 bg-gray-50">
                    ...
                    <div class="mb-3">
                        <h3 class="text-2xl font-semibold tracking-wide text-blue-800 font-montserrat">Ubah Pengalaman Kerja
                        </h3>
                    ...
                    <form wire:submit='update'>
                        ...
                        <div class="mb-2">
                            ...
                            <input wire:model='job_description' type="hidden" id="job_description" class="hidden" value='{!! $applicantworkexperience->job_description !!}'>
                            <div wire:ignore >
