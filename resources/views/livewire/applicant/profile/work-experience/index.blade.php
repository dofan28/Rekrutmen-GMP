                ...
                <div class="flex flex-col p-4 space-y-4 bg-gray-50">
                    ...
                    <div class="mb-3">
                        @if (auth()->user()->educationalbackground->isEmpty())
                            <h3 class="text-2xl font-semibold tracking-wide text-blue-800 font-montserrat">Pengalaman Kerja
                            </h3>
                            <p class="my-2 text-sm font-light text-gray-800 font-poppins ">Lengkapi data pengalaman kerja berikut. Untuk menjadi nilai tambah dalam proses seleksi lamaran.</p>
                        @else
                        ...
                        @foreach (auth()->user()->educationalbackground as $educationalbackground)
                            <div wire:key='{{ $educationalbackground->id }}' class="flex justify-between">
                                ...
                                <div class="flex gap-1">
                                    <div>
                                        <a wire:navigate href="/applicant/profile/workexperiences/{{ $educationalbackground->id }}/edit"
