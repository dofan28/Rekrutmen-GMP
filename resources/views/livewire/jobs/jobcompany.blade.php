    ...
    <div>
        <div class="flex justify-center items-end h-80 bg-cover bg-center"
            ...
            <div class="flex flex-col justify-between w-full h-3/5 text-center ">
                <div>
                    <h1 class="lg:text-4xl md:text-3xl sm:text-2xl font-bold font-montserrat text-gray-100 uppercase">
                        LOWONGAN KERJA <br> {{ $jobcompany->name }}</h1>
                    <p class="font-poppins mt-3 lg:text-xl md:text-lg sm:text-lg font-semibold text-gray-100">Temukan
                        pilihan karier anda di cabang {{ $jobcompany->name }}
