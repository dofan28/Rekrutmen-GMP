    <div class="flex flex-col w-full px-4 py-8 overflow-y-auto border-b lg:border-r lg:h-screen lg:w-64">
        <div class="flex flex-col justify-between mt-6 h-full">
            <aside>
                <ul>
                    @if (Auth::user()->role == 'applicant')
                        <li>
                            <a class="flex items-center px-4 py-2 text-gray-800 bg-gray-50 "
                                ...
                                <span class="mx-4 font-medium">Lamaran Saya</span>
                            </a>
                        </li>

                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100"
                                href="/applicant/jobs">
                                ...
                                <span class="mx-4 font-medium">Lowongan</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100"
                    ...
                    @elseif(Auth::user()->role == 'hrd')
                        <li>
                            <a class="flex items-center px-4 py-2 text-gray-800 bg-gray-50 "
                                ...
                                <span class="mx-4 font-medium">Mengelola Lamaran</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100"
                                ...
                                <span class="mx-4 font-medium">Mengelola Lowongan</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100"
                    ...
                    @elseif (Auth::user()->role == 'admin')
                        ...
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100"
                                ...
                                <span class="mx-4 font-medium">Data Lowongan</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100" href="#">
                                ...
                                <span class="mx-4 font-medium">Data Pelamar</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100" href="#">
                                ...
                                <span class="mx-4 font-medium">Data Lamaran</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-800 hover:bg-gray-100" href="#">
                                ...
                                <span class="mx-4 font-medium">Data HRD</span>
                            </a>
                        </li>
                    @endif
                </ul>
            ...
            <div>
                <a class="flex items-center px-4 py-2 text-gray-800 bg-gray-50 " href="logout">
                    {{-- <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 -960 960 960">
                                    <path
                                        d="M200-200h560v-367L567-760H200v560Zm-80 80v-720h480l240 240v480H120Zm160-160h400v-80H280v80Zm0-160h400v-80H280v80Zm0-160h280v-80H280v80Zm-80 400v-560 560Z"
                                        />
