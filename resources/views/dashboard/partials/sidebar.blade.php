    <div class="flex flex-col bg-blue-800 w-full px-4 py-8 overflow-y-auto border-b lg:border-r lg:h-screen lg:w-64">
                        ...
                        <li x-data="{ isHovered: false }">
                            <a wire:navigate @mouseover="isHovered = true" @mouseout="isHovered = false"
                                ...
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6"
                                        :class="isHovered ? 'fill-blue-800' : (
                                            {{ json_encode(request()->is('applicant/jobs*')) }} ? 'fill-blue-800' :
                                            'fill-gray-50')"
                                        viewBox="0 -960 960 960" fill='#f9fafb'>
                                        <path
