@if (Auth::user()->role == 'applicant')
    <a wire:navigate x-data="{ isHovered: false }" @mouseover="isHovered = true" @mouseout="isHovered = false"
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="h-6 w-6"
                :class="isHovered ? 'fill-gray-50' : (
                    {{ json_encode(request()->is('applicant/profile/applicantdata*')) }} ?
                    'fill-gray-50' : 'fill-blue-800')">
                <path
    ...
    <a wire:navigate x-data="{ isHovered: false }" @mouseover="isHovered = true" @mouseout="isHovered = false"
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="h-6 w-6"
                :class="isHovered ? 'fill-gray-50' : (
                    {{ json_encode(request()->is('applicant/profile/contact*')) }} ?
                    'fill-gray-50' : 'fill-blue-800')">
                <path
    ...
    <a wire:navigate x-data="{ isHovered: false }" @mouseover="isHovered = true" @mouseout="isHovered = false"
        ...
        <div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="h-6 w-6"
                :class="isHovered ? 'fill-gray-50' : (
                    {{ json_encode(request()->is('applicant/profile/educationalbackgrounds*')) }} ?
                    'fill-gray-50' : 'fill-blue-800')">
                <path
    ...
    <a wire:navigate x-data="{ isHovered: false }" @mouseover="isHovered = true" @mouseout="isHovered = false"
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="h-6 w-6"
                :class="isHovered ? 'fill-gray-50' : (
                    {{ json_encode(request()->is('applicant/profile/workexperiences*')) }} ?
                    'fill-gray-50' : 'fill-blue-800')">
                <path
    ...
    <a wire:navigate x-data="{ isHovered: false }" @mouseover="isHovered = true" @mouseout="isHovered = false"
        href="/applicant/profile/securitysettings"
        class="flex items-center bg-blue text-sm p-2 hover:bg-blue-800 hover:text-gray-100 {{ request()->is('applicant/profile/securitysettings*') ? 'bg-blue-800 text-gray-100' : 'bg-gray-100' }}">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="h-6 w-6"
                :class="isHovered ? 'fill-gray-50' : (
                    {{ json_encode(request()->is('applicant/profile/securitysettings*')) }} ?
                    'fill-gray-50' : 'fill-blue-800')">
                <path
...
@elseif (Auth()->user()->role == 'hrd')
    <a wire:navigate x-data="{ isHovered: false }" @mouseover="isHovered = true" @mouseout="isHovered = false"
        ...
        class="flex items-center bg-blue text-sm p-2 hover:bg-blue-800 hover:text-gray-100 {{ request()->is('hrd/profile/myaccount') ? 'bg-blue-800 text-gray-100' : 'bg-gray-100' }}">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg"viewBox="0 -960 960 960" class="h-6 w-6"
                :class="isHovered ? 'fill-gray-50' : (
                    {{ json_encode(request()->is('hrd/profile/myaccount*')) }} ?
                    'fill-gray-50' : 'fill-blue-800')">
                <path
        ...
        <span class="ml-2 font-medium font-montserrat">Akun Saya</span>
    </a>
    <a wire:navigate x-data="{ isHovered: false }" @mouseover="isHovered = true" @mouseout="isHovered = false"
        href="/hrd/profile/securitysettings"
        class="flex items-center bg-blue text-sm p-2 hover:bg-blue-800 hover:text-gray-100 {{ request()->is('hrd/profile/securitysettings*') ? 'bg-blue-800 text-gray-100' : 'bg-gray-100' }}">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="h-6 w-6"
                :class="isHovered ? 'fill-gray-50' : (
                    {{ json_encode(request()->is('hrd/profile/securitysettings*')) }} ?
                    'fill-gray-50' : 'fill-blue-800')">
                <path
                    d="m370-80-16-128q-13-5-24.5-12T307-235l-119 50L78-375l103-78q-1-7-1-13.5v-27q0-6.5 1-13.5L78-585l110-190 119 50q11-8 23-15t24-12l16-128h220l16 128q13 5 24.5 12t22.5 15l119-50 110 190-103 78q1 7 1 13.5v27q0 6.5-2 13.5l103 78-110 190-118-50q-11 8-23 15t-24 12L590-80H370Zm70-80h79l14-106q31-8 57.5-23.5T639-327l99 41 39-68-86-65q5-14 7-29.5t2-31.5q0-16-2-31.5t-7-29.5l86-65-39-68-99 42q-22-23-48.5-38.5T533-694l-13-106h-79l-14 106q-31 8-57.5 23.5T321-633l-99-41-39 68 86 64q-5 15-7 30t-2 32q0 16 2 31t7 30l-86 65 39 68 99-42q22 23 48.5 38.5T427-266l13 106Zm42-180q58 0 99-41t41-99q0-58-41-99t-99-41q-59 0-99.5 41T342-480q0 58 40.5 99t99.5 41Zm-2-140Z" />
            </svg>
