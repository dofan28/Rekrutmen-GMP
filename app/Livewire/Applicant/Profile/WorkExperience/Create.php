...
#[Title('Tambahkan Pengalaman Kerja Saya | Rekrutmen PT. Graha Mutu Persada')]
...
class Create extends Component
{
    ...
    public function save(){
        ...
        session()->flash('success', 'Data pengalaman kerja berhasil ditambahkan.');

        $this->redirect('/applicant/profile/workexperiences');
    }
    public function render()
    {
        return view('livewire.applicant.profile.work-experience.create');
    }
}
