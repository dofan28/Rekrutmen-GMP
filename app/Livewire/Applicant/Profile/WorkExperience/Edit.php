...
#[Title('Ubah Pengalaman Kerja Saya | Rekrutmen PT. Graha Mutu Persada')]
...
class Edit extends Component
{
    ...
    public function mount(ApplicantWorkExperience $applicantworkexperience){
        $this->applicantworkexperience = $applicantworkexperience;

        $this->fill($applicantworkexperience->only('company', 'position', 'last_salary','job_description', 'start_date', 'end_date'),);
    }
    ...
    public function update(){
        ...
        $applicantworkexperience = $this->applicantworkexperience;

        $applicantworkexperience->update($validatedData);

        session()->flash('success', 'Data pengalaman kerja berhasil diubah.');
    ...
    {
        return view('livewire.applicant.profile.work-experience.edit');
    }
}
