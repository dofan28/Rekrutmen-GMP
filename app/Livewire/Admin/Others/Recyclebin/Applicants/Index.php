        ...
        $applicants = User::where('role', 'applicant')
            ->when($this->search, function ($query) {
                $query->where(function ($subQuery) {
                    $subQuery->where('username', 'like', '%' . $this->search . '%')->orWhere('email', 'like', '%' . $this->search . '%')
                        ->orWhereHas('applicantdata', function ($applicantdataQuery) {
                            $applicantdataQuery->where('ktp_number', 'like', '%' . $this->search . '%')
                        ...
                        ->orWhereHas('contact', function ($contactQuery) {
                            $contactQuery->where('street', 'like', '%' . $this->search . '%')
                        ...
                        ->orWhereHas('educationalbackground', function ($educationalbackgroundQuery) {
                            $educationalbackgroundQuery->where('institution', 'like', '%' . $this->search . '%')
                        ...
                        ->orWhereHas('workexperience', function ($workexperienceQuery) {
                            $workexperienceQuery->where('company', 'like', '%' . $this->search . '%')
                        ...
                        ->orWhereHas('organizationalexperience', function ($organizationalexperienceQuery) {
                            $organizationalexperienceQuery->where('organizational_name', 'like', '%' . $this->search . '%')
                                ->orWhere('position', 'like', '%' . $this->search . '%')
